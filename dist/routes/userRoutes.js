...
router.get('/medical-officers', auth_1.authenticate, (0, auth_1.authorize)(['county_director']), userController_1.getAllMedicalOfficers);
...
// Get user by ID
router.get('/:userId', auth_1.authenticate, userController_1.getUserById);
